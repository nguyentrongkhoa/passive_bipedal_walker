# NOTE: colcon build --packages-select walker_design_5 && source ~/.bashrc
# NOTE: ros2 launch walker_design_5 exhaustive_simulation.launch.py
...
def generate_launch_description(): 
    ...
    pkg_share = FindPackageShare(package='walker_design_5').find('walker_design_5')
