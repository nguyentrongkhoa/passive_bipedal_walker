...
class ExhaustiveSimulationMasses(Node):
    def __init__(self, ramp_angle=2, new_simulation=True, walker_counter=0, csv_filename='mass_simulation_result.csv'):
        ...
        self.SPAWN_Z_OFFSET = 5 * sin(self.RAMP_ANGLE_IN_RAD) + 0.02
        ...
        self.PATH_TO_URDF = os.path.join(get_package_share_directory('walker_design_3'), 'urdf')
        self.URDF_TREE = ET.parse(f'{self.PATH_TO_URDF}/walker_design_3.urdf')
